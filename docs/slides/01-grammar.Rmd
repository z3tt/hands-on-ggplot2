...
```{r structure-geom-line, fig.width = 16, fig.height = 5.8}
ggplot(data, aes(date, close)) +
  geom_line() #<<
```
...
```{r structure-aes-line-groups, fig.width = 16, fig.height = 5.8}
...
```{r structure-aes-line-colors, fig.width = 16, fig.height = 5.8}
