...
<br><br>
# Hands–On Data Visualization with <code style='color:#ebc500;'>ggplot2</code><br><b style='font-size:25pt;color:#a7a7a7;'>Segment 5: Create Multi-Panel Figures</b>
...
Build up your multi-panel plot sequentially using **The Composer of Plots**:
...
```{r patchwork, fig.width=14, fig.height=5.4, fig.align="center"}
...
```{r patchwork-2, fig.height=5.8, fig.align="center"}
time / box #<<
```
...
```{r patchwork-widths, fig.width=14, fig.height=5.4, fig.align="center"}
time + box + 
...
```{r patchwork-spacer, fig.width=14, fig.height=5.4, fig.align="center"}
...
* Using the [“Datasaurus Dozen”](http://www.thefunctionalart.com/2016/08/download-datasaurus-never-trust-summary.html) data set and the previous codes, create this multi-panel visualization<br>with the help of `facet_wrap()` and the `{patchwork}` package.
...
## Exercise 2: Create Multi-Panel Plot
