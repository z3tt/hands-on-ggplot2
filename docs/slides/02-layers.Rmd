...
## <code style='font-weight:700;'>stat\_\*()</code> versus <code style='font-weight:700;'>geom\_\*()</code>
...
## Statistical Transformations: <code style='font-weight:700;'>stat\_\*()</code>
