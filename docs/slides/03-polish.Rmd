...
## Adjust Colors and Other <code style='font-weight:700;'>aes</code>thetics
...
## Scales: <code style='font-weight:700;'>scale\_\*()</code>
...
## Scales: <code style='font-weight:700;'>scale\_color\_\*()</code>
...
## Scales: <code style='font-weight:700;'>scale\_color\_viridis_\*()</code>
...
## Scales: <code style='font-weight:700;'>scale\_color\_brewer_\*()</code>
...
## Scales: <code style='font-weight:700;'>scale\_fill\_gradient()</code>
...
## Scales: <code style='font-weight:700;'>scale\_fill\_gradient2()</code>
...
## Color Palettes in <code style='font-weight:700;'>R</code>
...
## Style Legends: <code style='font-weight:700;'>guides()</code>
...
## Style Legends: <code style='font-weight:700;'>theme()</code>
...
## Themes: <code style='font-weight:700;'>theme_*()</code>
...
## <code style='font-weight:700;'>theme()</code> Arguments</b>
...
## Exercise 3: <code style='font-weight:700;'>theme_grey|gray()</code
...
## Exercise 3: <code style='font-weight:700;'>theme_dark()</code>
